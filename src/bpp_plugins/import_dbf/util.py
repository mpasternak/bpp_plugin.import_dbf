...
from bpp_plugins.import_dbf import models as dbf
...
def mapuj_elementy_publikacji(offset, limit):
    ...
    for rec in iter:
        ...
        # bpp=# select distinct(substr(comm, 1, 3)) from bpp_plugins.import_dbf_b_u;
        #  substr
        # --------
...
def integruj_publikacje(offset=None, limit=None):
    ...
    #
    # postgres=# select distinct substr(tytul_or, 0, 6) from bpp_plugins.import_dbf_bib;
    #  substr
    # --------
    #  #102$
    #  #150$
    ...
    # bpp=# select distinct substr(title, 1, 4) from bpp_plugins.import_dbf_bib;
    #  substr
    # --------
    #  #105
    #  #157
    ...
    # postgres=# select distinct substr(zrodlo, 0, 6) from bpp_plugins.import_dbf_bib;
    #  substr
    # --------
    ...
    for rec in iter:
        ...
        # kbr -- co to za pole?
        # bpp=# select distinct kbr, count(*) from bpp_plugins.import_dbf_bib group by kbr;
        #  kbr | count
        # -----+-------
        #      | 86354
        #  000 |    41
        ...
        # lf -- co to za pole?
        # bpp=# select distinct lf, count(*) from bpp_plugins.import_dbf_bib group by lf;
        #  lf | count
        # ----+-------
        #     |  9605
        #  0  | 66617
        ...
        # bpp=# select distinct study_gr, count(*) from bpp_plugins.import_dbf_bib group by study_gr;
        #  study_gr | count
        # ----------+-------
        #  0        | 86026
        #  1        |   390
        ...
        # bpp=# select distinct kwartyl, count(*) from bpp_plugins.import_dbf_bib group by kwartyl;
        #  kwartyl | count
        # ---------+-------
        #          | 85236
        #  A       |    37
        ...
        # bpp=# select distinct lis_numer, count(*) from bpp_plugins.import_dbf_bib group by lis_numer;
        #  lis_numer | count
        # -----------+-------
        #            | 86365
        #  10226     |     1
