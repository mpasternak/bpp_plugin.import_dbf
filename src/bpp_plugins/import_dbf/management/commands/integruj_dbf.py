...
from bpp_plugins.import_dbf.models import B_A, Bib
from bpp_plugins.import_dbf.util import (
    integruj_autorow,
    integruj_b_a,
    integruj_charaktery,
    ...
    def handle(
        ...
        **options
        ...
        if enable_all or options["enable_autor"]:
            ...
            # from bpp_plugins.import_dbf_aut where exp_id = idt_aut) select x, array_agg(y)
